...
def main():
    ...
    if os.path.exists(f'cache/query/{query_modality}-{os.path.splitext(query_file)[0]}.npy'):
        ...
        os.rename(f'cache/query/{os.path.splitext(query_file)[0]}.npy',
                  f'cache/query/{query_modality}-{os.path.splitext(query_file)[0]}.npy')
    ...
    run_command(
        f'python clamp3_search.py ../cache/query/{query_modality}-{os.path.splitext(query_file)[0]}.npy ../cache/{ref_modality}-{ref_dir} --top_k {top_k}')

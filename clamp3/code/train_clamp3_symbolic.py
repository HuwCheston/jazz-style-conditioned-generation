...
class TextMusicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # mask music inputs
        music_inputs = patchilizer.encode(item, add_special_patches=True, truncate=True,
...
if __name__ == "__main__":
    ...
    train_set = DataLoader(train_set, batch_size=CLAMP3_BATCH_SIZE, collate_fn=collate_batch, sampler=train_sampler,
                           shuffle=(train_sampler is None))
    eval_set = DataLoader(eval_set, batch_size=CLAMP3_BATCH_SIZE, collate_fn=collate_batch, sampler=eval_sampler,
                          shuffle=(train_sampler is None))

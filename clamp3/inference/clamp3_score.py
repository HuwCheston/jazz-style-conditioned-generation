...
def calculate_pairwise_similarity(query_features, query_filenames, reference_features, reference_filenames):
    ...
    if unmatched_files:
        ...
        print(
            f"There are {len(unmatched_files)} unmatched query or reference files. Check 'inference/unmatched_files.jsonl' for details.")
...
if __name__ == '__main__':
    ...
    parser.add_argument('reference_folder', type=str,
                        help='Path to the folder containing reference features (.npy files).')
    parser.add_argument('--group', action='store_true',
                        help='Calculate group similarity instead of pairwise similarity.')

...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, required=True,
                        help="Path to the HuBERT model for feature extraction.")
    parser.add_argument("--mean_features", action="store_true",
                        help="Calculate mean of features along the first dimension.")
